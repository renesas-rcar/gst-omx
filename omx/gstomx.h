 ...
 */
#define GST_OMX_HACK_DEFAULT_PIXEL_ASPECT_RATIO                       G_GUINT64_CONSTANT (0x0000000000000800)

/* If the component does not handle for codec data. Skip this handling
 * Happens with Renesas OMX WMADEC
 */
#define GST_OMX_HACK_SKIP_HANDLE_CODEC_DATA                            G_GUINT64_CONSTANT (0x0000000000001000)
 ...
 * of nStride in OMX.
 */
#define GST_OMX_HACK_RENESAS_ENCMC_STRIDE_ALIGN                   G_GUINT64_CONSTANT (0x0000000000002000)
